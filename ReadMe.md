...
### voxy
For a better gaming experience I would recommend using the [voxy Neoforge Port](https://github.com/j-shelfwood/voxy-neoforge) for a similar & less hardware intensive experience.

Due to [voxy](https://modrinth.com/mod/voxy) prohibiting the redistribution of modified versions I can't put the port into this pack, to tackle this issue u need to build the .jar yourself.

The repository includes building instructions, if errors appear u might need to ignore mixin-validation with the following command:

```
./gradlew build -x validateMixins
```
**WARNINGS:** 
> I am not in any way associated with this port & you are responsible for the safety of your own devices & data. 
> ALWAYS check foreign software for potential risk!
...
### Non-Modrinth Mods
- [Configured by Mr Crayfish](https://www.curseforge.com/minecraft/mc-mods/configured/files/7276577) - licensed under [LGPLv3](https://www.curseforge.com/minecraft/mc-mods/configured#license)
- [Framework by Mr Crayfish](https://www.curseforge.com/minecraft/mc-mods/framework)- licensed under [LGPL-2.1](https://github.com/MrCrayfish/Framework/blob/multiloader/26.1/LICENSE)
- [Backpacked by Mr Crayfish](https://www.curseforge.com/minecraft/mc-mods/backpacked) -licensed under [LGPL-2.1](https://github.com/MrCrayfish/Backpacked/blob/multiloader/1.21.1/LICENSE)
- [Backpacked Hide Backpacks by tyler2269](https://www.curseforge.com/minecraft/mc-mods/backpacked-hide-backpacks) - licensed under [MIT](https://www.curseforge.com/minecraft/mc-mods/backpacked-hide-backpacks#license)
- [Brewing and Chewing Fork by OskaFlightboom](https://github.com/OskaFlightboom/BrewinAndChewinForNeoForgewithFarmersDelight1.3.2)- licensed under MIT
- An edited Version of the [Kiss Mod](https://modrinth.com/mod/kiss-fabric/version/plUmdfHo) - [see edit here](https://github.com/jiazengp/kiss-fabric/issues/3)